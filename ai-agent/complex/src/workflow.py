...
class Workflow:
    ...
    def _extract_tools_step(self, state: ResearchState) -> Dict[str, Any]:
        ...
        articl_query = f"{state.query} tools comparison best alternatives"
        search_results = self.firecrawl_service.search_companies(articl_query, num_results=3)
    ...
    def _analyze_company_content(self, company_name:str, content:str) -> CompanyAnalysis:
        ...
        try:
            ...
            print(f"Analysis for {company_name} completed successfully.")
            return response
    ...
    def _research_step(self, state: ResearchState) -> Dict[str, Any]:
        ...
        print(f"Analyzing {len(tool_names)} tools: {', '.join(tool_names)}")
        
        companies = []
        for tool_name in tool_names:
            tool_search_results = self.firecrawl_service.search_companies(tool_name, num_results=1)
    ...
    def _analyze_step(self, state: ResearchState) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"recommendation": "Failed to generate recommendation."}
